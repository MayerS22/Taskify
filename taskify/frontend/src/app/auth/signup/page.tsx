  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-purple-100 px-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col md:flex-row overflow-hidden border border-gray-100">
        {/* Left: Image */}
        <div className="hidden md:flex md:w-1/2 items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-6 md:p-10 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
          <Image
        ...
        <form
          ...
          className="flex-1 p-8 md:p-10 flex flex-col gap-6 justify-center animate-fadeInUp" style={{ animationDelay: '0.25s' }}
        >
          <div className="flex flex-col items-center mb-2">
            <h2 className="text-3xl font-extrabold text-gray-800 mb-1">Create Account</h2>
            <p className="text-gray-700 text-sm">Sign up to get started</p>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-2">
            <button
              ...
              onClick={() => alert('Google sign up (to be implemented)')}
            >
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-3 w-full py-2 px-4 border border-gray-300 rounded-lg bg-white text-gray-800 font-semibold hover:bg-gray-50 hover:scale-105 transition-transform transition-shadow duration-200"
              onClick={() => alert('GitHub sign up (to be implemented)')}
            >
